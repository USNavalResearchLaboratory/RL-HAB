...
project_name = "aeolus-SEA-2023-Jun"  # Name of Optuna database and Wandb project name
model_path="aeolus-SEA-2023-Jun"      # Where SB3 RL models will be stored
log_path = "aeolus-SEA-2023-Jun"           # Where SB3 log files will be stored
