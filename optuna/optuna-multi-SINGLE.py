...
def objective(trial):
    ...
    env = make_vec_env(lambda: FlowFieldEnv3d_SINGLE(FORECAST_PRIMARY=FORECAST_PRIMARY), n_envs=optuna_config.n_envs)



    eval_env = DummyVecEnv([lambda: Monitor(FlowFieldEnv3d_SINGLE(FORECAST_PRIMARY=FORECAST_PRIMARY))])
