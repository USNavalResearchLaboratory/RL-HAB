...
def gpr_compare():
    ...
    pres = forecast_subset_era5.ds.level.values[2]
    print(pres)
    ...
    grid_spacing = 5000  # Example: use every 5th point in the lat/lon arrays
    ...
    for num_samples in observation_steps:
        ...
        noise_levels = np.array([2 ** 2 if t == 'noisy' else .75 ** 2 for t in types_combined])
